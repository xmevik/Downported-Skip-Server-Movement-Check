# Skip Server Movement Check

This mod was downported to Minecraft server 1.19.2, and tested with fabric loader 0.15.9.
...
- _Will this be updated to 1.x.x?_ - No. Ask the original author about any future plans.
...
Original author - <https://github.com/FrostbyteGames1>
Original mod repository - <https://github.com/FrostbyteGames1/Frostbytes-Skip-Server-Movement-Check/>
